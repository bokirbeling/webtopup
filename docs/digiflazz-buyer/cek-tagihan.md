...
Source URL: `https://developer.digiflazz.com/api/buyer/cek-tagihan/`
Fetched at: `2026-05-15T03:29:23.410Z`

Seluruh transaksi API diproses secara sinkron, jadi setiap request langsung mendapatkan respon status sukses atau gagal.
...
Jika produk yang ingin diintegrasikan termasuk daftar di atas, lihat struktur JSON khusus pada masing-masing produk.

Struktur JSON di bawah ini adalah format standar untuk memeriksa tagihan produk pascabayar di Digiflazz.

| Parameter | Deskripsi | Tipe Data | Wajib |
| --- | --- | --- | --- |
| `commands` | Perintah yang akan dieksekusi: `inq-pasca` | `String` | Ya |
...
| `periode` | Periode tagihan per lembar | `String` | Tidak |
...
| `jatuh_tempo` | Tanggal jatuh tempo | `String` | Tidak |
| `detail` | Detail setiap lembar tagihan | `-` | Ya |
| `periode` | Periode tagihan per lembar | `String` | Tidak |
| `nilai_tagihan` | Nilai tagihan periode tertentu | `String` | Tidak |
| `denda` | Biaya denda tagihan tertentu | `String` | Tidak |
| `meter_awal` | Meter awal | `String` | Tidak |
| `meter_akhir` | Meter akhir | `String` | Tidak |
| `biaya_lain` | Biaya lainnya | `String` | Tidak |
...
| `ref_id` | Ref ID unik Anda | `String` | Ya |
| `sign` | Signature dengan formula `md5(usrname + apiKey + ref_id)` | `String` | Ya |
| `year` | Tahun pajak. Jika kosong, memakai tahun berjalan | `Int` | Tidak |
| `testing` | Isi `true` apabila ingin melakukan development | `Boolean` | Tidak |
...
| `tahun_pajak` | Tahun pajak | `String` | Ya |
...
Tambahan field dibanding PBB: `provinsi`.
...
Field utama tambahan pada `desc.detail[]`: `meter_awal`, `meter_akhir`, `usage`.
...
Field utama tambahan pada `desc.detail[]`: `nilai_tagihan`, `no_ref`.
...
Field utama tambahan pada `desc`: `kode_iuran`, `kode_program`, `jkk`, `jkm`, `jht`, `kantor_cabang`, `tgl_efektif`, `tgl_expired`.
...
Field utama tambahan pada `desc`: `kode_iuran`, `jht`, `jkk`, `jkm`, `jpk`, `jpn`, `npp`, `kode_divisi`.
...
Field utama tambahan pada `desc`: `transaksi`, `no_registrasi`, `tanggal_registrasi`.
...
| `ref_id` | Ref ID unik Anda | `String` | Ya |
| `sign` | Signature dengan formula `md5(username + apiKey + ref_id)` | `String` | Ya |
| `amount` | Denominasi e-money yang diinginkan | `Int` | Ya |
| `testing` | Isi `true` apabila ingin melakukan development | `Boolean` | Tidak |
...
- Halaman resmi ini mengarahkan pengujian ke halaman `test-case.md`.
